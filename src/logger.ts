...
const TRADE_EVENTS = new Set<LogEvent>([
  "STRADDLE_ENTRY_START", "STRADDLE_FULLY_HEDGED", "STRADDLE_SKIPPED_NO_SLOT",
  "LEG1_FILLED", "LEG1_FAILED", "LEG2_FOK_FAILED", "LEG2_GTC_FAILED", "LEG2_GTC_FILLED",
  "LEG2_REPLACED", "LEG2_REPLACE_FAILED",
  "ORDER_RESPONSE", "ORDER_FAILED", "ORDER_CANCELLED", "CANCEL_FAILED",
  "RESOLUTION", "RESOLUTION_ERROR",
  "FILL_POLL_ERROR", "STOP_LOSS_TRIGGERED", "STOP_LOSS_FILLED", "STOP_LOSS_FAILED",
  "DCA_TRIGGERED", "DCA_FILLED", "DCA_FOK_FAILED",
  "REDEEM_CONFIRMED",
  "SHADOW_STRADDLE_CREATED", "SHADOW_RESOLUTION",
  "SLOT_ASSIGNED", "SLOT_WIN", "SLOT_LOSS_RESET",
  "SLOT_PROFIT_EXTRACTED", "SLOT_STATE_SNAPSHOT",
]);

const SYSTEM_EVENTS = new Set<LogEvent>([
  "SCAN_TICK", "DUMP_DETECTED", "SCAN_ERROR",
...
const CONSOLE_EVENTS = new Set<LogEvent>([
  "BOT_STARTED", "BOT_PAUSED", "BOT_RESUMED", "CONFIG_UPDATED",
  "STRADDLE_ENTRY_START", "STRADDLE_FULLY_HEDGED",
  "SHADOW_STRADDLE_CREATED",
