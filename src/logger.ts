...
const SYSTEM_EVENTS = new Set<LogEvent>([
  ...
  "QUOTE_SYNC_BLOCKED", "RANGE_SIDE_EVALUATED", "RANGE_SIDE_DECISION",
  "RANGE_SIDE_SKIPPED", "MARKET_QUALIFICATION_BLOCKED",
